            ...
            <div class="row align-items-md-stretch">
                <div class="col-md-6">
                    <div class="h-100 p-5 text-bg-dark rounded-3">
                        ...
                        <Form.Group className="col-6 ">
                            <Form.Label htmlFor="diasTrabajados">Marca con un check las tareas terminadas</Form.Label>
                            {['checkbox'].map((type) => (
                ...
                <div class="col-md-6">
                    <div class="h-100 p-5 bg-body-tertiary border rounded-3">
                        <h2 className='mb-3'>Estadisticas economicas</h2>
                        {proyectosActivos.map((proyecto) => (
                            <div key={proyecto.id}>
